...
def fetch_service_accessibility_data():
    """
    Fetches data for the Service Accessibility Map (Total Facilities and Density) 
    by reading the query from 'service_accessibility.sql'.
    """
    ...
    try:
        # Note: No parameters needed as this fetches data for ALL cities
